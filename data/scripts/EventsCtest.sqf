...
//CZ weapons
		_allWeapons = _allWeapons +   ["CZ_75_P_07_DUTY",12];
		_allWeapons = _allWeapons +   ["CZ_75_D_COMPACT",12];
		_allWeapons = _allWeapons +   ["CZ_75_SP_01_PHANTOM",12];
		_allWeapons = _allWeapons +   ["CZ_75_SP_01_PHANTOM_SD",12];
		_allWeapons = _allWeapons +   ["Evo_ACR",12];
		_allWeapons = _allWeapons +   ["Evo_mrad_ACR",12];
		_allWeapons = _allWeapons +   ["evo_sd_ACR",12];
		_allWeapons = _allWeapons +   ["UK59_ACR",12];
		_allWeapons = _allWeapons +   ["CZ_750_S1_ACR",12];
		_allWeapons = _allWeapons +   ["CZ805_A1_ACR",12];
		_allWeapons = _allWeapons +   ["CZ805_A1_GL_ACR",12];
		_allWeapons = _allWeapons +   ["CZ805_A2_ACR",12];
		_allWeapons = _allWeapons +   ["CZ805_A2_SD_ACR",12];
		_allWeapons = _allWeapons +   ["CZ805_B_GL_ACR",12];
		_allWeapons = _allWeapons +   ["LRTV_ACR",12];
//BAFX LEN
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_HG",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_CQB",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_CQB_SD",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_CQB_SD_HG",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF_SD",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_UGL",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_UGL_PF",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_CQB",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_CQB_SD",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_PF",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_PF_SD",12];
		_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_UGL_PF",12];
		
//new stuff
/*
		_allWeapons = _allWeapons +   ["R3F_AT4CS",12];
		_allWeapons = _allWeapons +   ["R3F_Minimi_EOT",12];
		_allWeapons = _allWeapons +   ["R3F_Minimi_J4",12];
		_allWeapons = _allWeapons +   ["R3F_Minimi_762_J4",12];
		_allWeapons = _allWeapons +   ["R3F_Minimi_762_OB50",12];
		_allWeapons = _allWeapons +   ["R3F_minimi_AIM_HG",12];
		_allWeapons = _allWeapons +   ["R3F_Minimi_762_EOT_HG",12];
		_allWeapons = _allWeapons +   ["R3F_JIM_LR",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_F1",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT",12];
//		_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT_HG_SD",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_F1_AIM",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_F1_J4_M203",12];
//		_allWeapons = _allWeapons +   ["R3F_Famas_F1_J4_M203_SD",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_felin",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_G2",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_G2_EOT",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_G2_J4",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_G2_J4_HG",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_G2_AIM_M203",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_G2_AIM_HG",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_surb",12];
//		_allWeapons = _allWeapons +   ["R3F_Famas_surb_EOT_SD",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_surb_AIM_HG",12];
//		_allWeapons = _allWeapons +   ["R3F_Famas_surb_AIM_SD",12];
		_allWeapons = _allWeapons +   ["R3F_Famas_surb_EOT_M203",12];
		_allWeapons = _allWeapons +   ["R3F_HK417L_NF",12];
		_allWeapons = _allWeapons +   ["R3F_HK417M_AIM",12];
		_allWeapons = _allWeapons +   ["R3F_HK417S_EOT_HG",12];
//		_allWeapons = _allWeapons +   ["R3F_HK417S_HG_SD",12];
		_allWeapons = _allWeapons +   ["R3F_FRF2_J8",12];
//		_allWeapons = _allWeapons +   ["R3F_FRF2_J8_SD",12];
		_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II",12];
		_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II_MILDOT",12];
		_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II_POLY",12];
//		_allWeapons = _allWeapons +   ["ACR_M4A3",12];
//		_allWeapons = _allWeapons +   ["ACR_M4A3_B",12];
		_allWeapons = _allWeapons +   ["ACR_M4A3_D",12];
//		_allWeapons = _allWeapons +   ["ACR_M4A3REF",12];
//		_allWeapons = _allWeapons +   ["ACR_M4A3REF_B",12];
		_allWeapons = _allWeapons +   ["ACR_M4A3REF_D",12];
//		_allWeapons = _allWeapons +   ["ACR_M4A3ACOG",12];
//		_allWeapons = _allWeapons +   ["ACR_M4A3ACOG_B",12];
		_allWeapons = _allWeapons +   ["ACR_M4A3ACOG_D",12];
//		_allWeapons = _allWeapons +   ["ACR_SD6",12];
//		_allWeapons = _allWeapons +   ["ACR_SD6_B",12];
		_allWeapons = _allWeapons +   ["ACR_SD6_D",12];
		_allWeapons = _allWeapons +   ["ACR_M60E4",12];
		_allWeapons = _allWeapons +   ["ACR_M60E4M1",12];
//		_allWeapons = _allWeapons +   ["ACR_SA58REF",12];
//		_allWeapons = _allWeapons +   ["ACR_SA58REF_B",12];
		_allWeapons = _allWeapons +   ["ACR_SA58REF_D",12];
//		_allWeapons = _allWeapons +   ["ACR_SA58ACOG",12];
//		_allWeapons = _allWeapons +   ["ACR_SA58ACOG_B",12];
		_allWeapons = _allWeapons +   ["ACR_SA58ACOG_D",12];
		_allWeapons = _allWeapons +   ["ACR_GLOCK17",12];
//		_allWeapons = _allWeapons +   ["ACR_GLOCK17SD",12];
		_allWeapons = _allWeapons +   ["ACR_CG",12];
//		_allWeapons = _allWeapons +   ["ACR_AW_308",12];
		_allWeapons = _allWeapons +   ["ACR_AW_308_D",12];

		_allWeapons = _allWeapons +   ["C1987_MP7",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_sd",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_su",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_su_sd",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_zp",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_zp_sd",12];
		_allWeapons = _allWeapons +   ["C1987_MP7_eot",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_eot_sd",12];
		_allWeapons = _allWeapons +   ["C1987_MP7_acog",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_acog_sd",12];
		_allWeapons = _allWeapons +   ["C1987_MP7_t",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_sd_t",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_su_t",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_su_sd_t",12];
		_allWeapons = _allWeapons +   ["C1987_MP7_zp_t",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_zp_sd_t",12];
		_allWeapons = _allWeapons +   ["C1987_MP7_eot_t",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_eot_sd_t",12];
		_allWeapons = _allWeapons +   ["C1987_MP7_acog_t",12];
//		_allWeapons = _allWeapons +   ["C1987_MP7_acog_sd_t",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_black",12];
		_allWeapons = _allWeapons +   ["C1987_P99_green",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_silver",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_black_laser",12];
		_allWeapons = _allWeapons +   ["C1987_P99_green_laser",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_silver_laser",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_black_sd",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_green_sd",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_silver_sd",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_black_laser_sd",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_green_laser_sd",12];
//		_allWeapons = _allWeapons +   ["C1987_P99_silver_laser_sd",12];

//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_SIL",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_FG",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_SIL_FG",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_GL",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_SIL_GL",12];

//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_SIL",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_FG",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_SIL_FG",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_GL",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_SIL_GL",12];

//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR_SIL",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR_FG",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR_SIL_FG",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR_GL",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR_SIL_GL",12];

//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_SIL",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_FG",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_SIL_FG",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_GL",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_SIL_GL",12];

//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_SIL",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_FG",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_SIL_FG",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_GL",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_SIL_GL",12];

//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_SIL",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_FG",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_SIL_FG",12];
		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_GL",12];
//		_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_SIL_GL",12];

//FHQ
		_allWeapons = _allWeapons +   ["FHQ_RSASS_TAN",12];
		_allWeapons = _allWeapons +   ["FHQ_RSASS_TWS_TAN",12];
//		_allWeapons = _allWeapons +   ["FHQ_RSASS_SD_TAN",12];
//		_allWeapons = _allWeapons +   ["FHQ_RSASS_TWS_SD_TAN",12];

		_allWeapons = _allWeapons +   ["FHQ_XM2010_DESERT",12];
//		_allWeapons = _allWeapons +   ["FHQ_XM2010_SD_DESERT",12];
		_allWeapons = _allWeapons +   ["FHQ_XM2010_NV_DESERT",12];
//		_allWeapons = _allWeapons +   ["FHQ_XM2010_NV_SD_DESERT",12];
		_allWeapons = _allWeapons +   ["FHQ_XM2010_TWS_DESERT",12];
//		_allWeapons = _allWeapons +   ["FHQ_XM2010_TWS_SD_DESERT",12];

		_allWeapons = _allWeapons +   ["FHQ_MSR_DESERT",12];
		_allWeapons = _allWeapons +   ["FHQ_MSR_NV_DESERT",12];
		_allWeapons = _allWeapons +   ["FHQ_MSR_TWS_DESERT",12];
//		_allWeapons = _allWeapons +   ["FHQ_MSR_SD_DESERT",12];
//		_allWeapons = _allWeapons +   ["FHQ_MSR_NV_SD_DESERT",12];
//		_allWeapons = _allWeapons +   ["FHQ_MSR_TWS_SD_DESERT",12];

//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_GL",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_GL_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_GL",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_GL_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_GL_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_GL_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_GL_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_GL_SD_F",12];

//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_SD_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_GL",12];
		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_GL_F",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_GL_SD",12];
//		_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_GL_SD_F",12];
//RH Weapons
			_allWeapons = _allWeapons +   ["RH_m93r",12];
			_allWeapons = _allWeapons +   ["RH_p226",12];
//			_allWeapons = _allWeapons +   ["RH_g17",12];
			_allWeapons = _allWeapons +   ["RH_g18",12];
			_allWeapons = _allWeapons +   ["RH_g19t",12];
//			_allWeapons = _allWeapons +   ["RH_mk2",12];
			_allWeapons = _allWeapons +   ["RH_mk22v",12];
//			_allWeapons = _allWeapons +   ["RH_mk22vsd",12];
			_allWeapons = _allWeapons +   ["RH_usp",12];
//			_allWeapons = _allWeapons +   ["RH_uspsd",12];
			_allWeapons = _allWeapons +   ["RH_m9",12];
//			_allWeapons = _allWeapons +   ["RH_m9sd",12];
			_allWeapons = _allWeapons +   ["RH_m1911",12];
//			_allWeapons = _allWeapons +   ["RH_m1911sd",12];
			_allWeapons = _allWeapons +   ["RH_anac",12];
			_allWeapons = _allWeapons +   ["RH_bull",12];
			_allWeapons = _allWeapons +   ["RH_python",12];
			_allWeapons = _allWeapons +   ["RH_deagle",12];
			_allWeapons = _allWeapons +   ["RH_pp2000p",12];
			_allWeapons = _allWeapons +   ["RH_mac10p",12];
			_allWeapons = _allWeapons +   ["RH_tec9",12];
//			_allWeapons = _allWeapons +   ["RH_muzi",12];
			_allWeapons = _allWeapons +   ["RH_mp5kp",12];
			_allWeapons = _allWeapons +   ["RH_mp7p",12];
			_allWeapons = _allWeapons +   ["RH_HK53aim",12];
			_allWeapons = _allWeapons +   ["RH_mp5a4rfx",12];
//			_allWeapons = _allWeapons +   ["RH_mp5a5eot",12];
			_allWeapons = _allWeapons +   ["RH_mp5a5ris",12];
			_allWeapons = _allWeapons +   ["RH_mp5a5eodRFX",12];
			_allWeapons = _allWeapons +   ["RH_mp5sd6eot",12];
//			_allWeapons = _allWeapons +   ["RH_mp5kpdw",12];
			_allWeapons = _allWeapons +   ["RH_P90i",12];
//			_allWeapons = _allWeapons +   ["RH_P90isd",12];
			_allWeapons = _allWeapons +   ["RH_p90aim",12];
//			_allWeapons = _allWeapons +   ["RH_p90sdaim",12];
			_allWeapons = _allWeapons +   ["RH_umpeot",12];
			_allWeapons = _allWeapons +   ["RH_ump",12];
//			_allWeapons = _allWeapons +   ["RH_umpsd",12];
			_allWeapons = _allWeapons +   ["RH_umpaim",12];
//			_allWeapons = _allWeapons +   ["RH_umpsdaim",12];
//			_allWeapons = _allWeapons +   ["RH_krissRFX",12];
			_allWeapons = _allWeapons +   ["RH_kriss",12];
//			_allWeapons = _allWeapons +   ["RH_krisssd",12];
			_allWeapons = _allWeapons +   ["RH_krisseot",12];
//			_allWeapons = _allWeapons +   ["RH_krisssdeot",12];
			_allWeapons = _allWeapons +   ["RH_uzi",12];
//			_allWeapons = _allWeapons +   ["RH_uzisd",12];
			_allWeapons = _allWeapons +   ["RH_tmp",12];
//			_allWeapons = _allWeapons +   ["RH_tmpsd",12];
			_allWeapons = _allWeapons +   ["RH_tmpaim",12];
//			_allWeapons = _allWeapons +   ["RH_tmpsdaim",12];
			_allWeapons = _allWeapons +   ["RH_pp2000eot",12];
			_allWeapons = _allWeapons +   ["RH_mp7eot",12];
//			_allWeapons = _allWeapons +   ["RH_mp7sdeot",12];
			_allWeapons = _allWeapons +   ["RH_mp7aim",12];
//			_allWeapons = _allWeapons +   ["RH_mp7sdaim",12];
			_allWeapons = _allWeapons +   ["RH_fmg9",12];
			_allWeapons = _allWeapons +   ["RH_pdreot",12];
			_allWeapons = _allWeapons +   ["RH_PDW_AIM",12];
//			_allWeapons = _allWeapons +   ["RH_M4CMK",12];
//			_allWeapons = _allWeapons +   ["RH_M4CMKAIM",12];
			_allWeapons = _allWeapons +   ["RH_M4CMKEOTECH",12];
			_allWeapons = _allWeapons +   ["RH_M4CMKACOG",12];
			_allWeapons = _allWeapons +   ["RH_ar10",12];
			_allWeapons = _allWeapons +   ["RH_ar10s",12];
//			_allWeapons = _allWeapons +   ["RH_m14",12];
//			_allWeapons = _allWeapons +   ["RH_m14aim",12];
//			_allWeapons = _allWeapons +   ["RH_mk14teot",12];
			_allWeapons = _allWeapons +   ["RH_mk14t",12];
//			_allWeapons = _allWeapons +   ["RH_mk14tsd",12];
			_allWeapons = _allWeapons +   ["RH_MK14AIM",12];
//			_allWeapons = _allWeapons +   ["RH_MK14SDAIM",12];
			_allWeapons = _allWeapons +   ["RH_MK14",12];
//			_allWeapons = _allWeapons +   ["RH_MK14SD",12];
			_allWeapons = _allWeapons +   ["RH_MK14EOTECH",12];
//			_allWeapons = _allWeapons +   ["RH_MK14SDEOTECH",12];
			_allWeapons = _allWeapons +   ["RH_m16a3cs",12];
//			_allWeapons = _allWeapons +   ["RH_m4a1r",12];
			_allWeapons = _allWeapons +   ["RH_m4a1eotech",12];
//			_allWeapons = _allWeapons +   ["RH_m4sdeotech",12];
//			_allWeapons = _allWeapons +   ["RH_m4acog",12];
			_allWeapons = _allWeapons +   ["RH_m4",12];
//			_allWeapons = _allWeapons +   ["RH_m4sd",12];
//			_allWeapons = _allWeapons +   ["RH_m4macog",12];
			_allWeapons = _allWeapons +   ["RH_M4sdaim_wdl",12];
			_allWeapons = _allWeapons +   ["RH_m4sbraim",12];
			_allWeapons = _allWeapons +   ["RH_M4CTSD_F",12];
//			_allWeapons = _allWeapons +   ["RH_sc2",12];
			_allWeapons = _allWeapons +   ["RH_sc2aim",12];
			_allWeapons = _allWeapons +   ["RH_sc2shd",12];

			_allWeapons = _allWeapons +   ["RH_mk18",12];
			_allWeapons = _allWeapons +   ["RH_Mk18aim",12];
			_allWeapons = _allWeapons +   ["RH_mk18eot",12];
			_allWeapons = _allWeapons +   ["RH_Mk18acog",12];

			_allWeapons = _allWeapons +   ["RH_mk18sd",12];
			_allWeapons = _allWeapons +   ["RH_Mk18sdaim",12];
			_allWeapons = _allWeapons +   ["RH_Mk18sdeot",12];
			_allWeapons = _allWeapons +   ["RH_Mk18sdacog",12];

			_allWeapons = _allWeapons +   ["RH_Mk18gl",12];
			_allWeapons = _allWeapons +   ["RH_Mk18glaim",12];
			_allWeapons = _allWeapons +   ["RH_Mk18gleot",12];
			_allWeapons = _allWeapons +   ["RH_mk18glacog",12];

//			_allWeapons = _allWeapons +   ["RH_SCARL_AIM",12];
			_allWeapons = _allWeapons +   ["RH_SCARL_MK4",12];
			_allWeapons = _allWeapons +   ["RH_SCARL_SD_DOC",12];
			_allWeapons = _allWeapons +   ["RH_SCARLB_SD_EOTECH",12];
			_allWeapons = _allWeapons +   ["RH_SCARH_MK4",12];
//			_allWeapons = _allWeapons +   ["RH_SCARH_SPECTERDR",12];
			_allWeapons = _allWeapons +   ["RH_SCARH_SD_ACOG",12];
//			_allWeapons = _allWeapons +   ["RH_m16a2gl",12];
			_allWeapons = _allWeapons +   ["RH_m16a3sgl",12];
//			_allWeapons = _allWeapons +   ["RH_m16a4glacog",12];
			_allWeapons = _allWeapons +   ["RH_m16a4gleotech",12];
//			_allWeapons = _allWeapons +   ["RH_m4gl",12];
			_allWeapons = _allWeapons +   ["RH_M4sdgleotech_wdl",12];
//			_allWeapons = _allWeapons +   ["RH_m4sdglaim",12];
//			_allWeapons = _allWeapons +   ["RH_m4sdglacog",12];
			_allWeapons = _allWeapons +   ["RH_M4CTSDGLACOG_F",12];
//			_allWeapons = _allWeapons +   ["RH_M4CTSDGL_F",12];
			_allWeapons = _allWeapons +   ["RH_XM8DGL",12];
			_allWeapons = _allWeapons +   ["RH_SCARH_GL_EOTECH",12];
			_allWeapons = _allWeapons +   ["RH_SCARH_GL_SPECTERDR",12];
			_allWeapons = _allWeapons +   ["RH_SCARLB_SD_GL_AIM",12];
			_allWeapons = _allWeapons +   ["RH_SCARL_GL_EOTECH",12];
			_allWeapons = _allWeapons +   ["RH_SCARLB_GL_ACOG",12];
//			_allWeapons = _allWeapons +   ["RH_m1s",12];
//			_allWeapons = _allWeapons +   ["RH_m1saim",12];
			_allWeapons = _allWeapons +   ["RH_m1ssp",12];
			_allWeapons = _allWeapons +   ["RH_m1steot",12];
			_allWeapons = _allWeapons +   ["RH_M14EBRSP",12];
//			_allWeapons = _allWeapons +   ["RH_M14EBRSP_SD",12];
//			_allWeapons = _allWeapons +   ["RH_mk14ebrsp",12];
//			_allWeapons = _allWeapons +   ["RH_mk14ebr_sd",12];
			_allWeapons = _allWeapons +   ["RH_mk14ebrsp_sd",12];
			_allWeapons = _allWeapons +   ["RH_m39emr",12];
			_allWeapons = _allWeapons +   ["RH_mk12mod1",12];
//			_allWeapons = _allWeapons +   ["RH_mk12sd",12];
			_allWeapons = _allWeapons +   ["RH_m21",12];
			_allWeapons = _allWeapons +   ["RH_MK21A5SD",12];
			_allWeapons = _allWeapons +   ["RH_m27",12];
			_allWeapons = _allWeapons +   ["RH_m27aim",12];
			_allWeapons = _allWeapons +   ["RH_m27cacog",12];
			_allWeapons = _allWeapons +   ["RH_m27ceotech",12];
			_allWeapons = _allWeapons +   ["RH_M249",12];
//			_allWeapons = _allWeapons +   ["RH_M249acog",12];
//			_allWeapons = _allWeapons +   ["RH_M249elcan",12];
			_allWeapons = _allWeapons +   ["RH_M249p",12];
//			_allWeapons = _allWeapons +   ["RH_M249pacog",12];
			_allWeapons = _allWeapons +   ["RH_M249pelcan",12];
			_allWeapons = _allWeapons +   ["RH_Mk48mod1",12];
			_allWeapons = _allWeapons +   ["RH_Mk48mod1acog",12];
//			_allWeapons = _allWeapons +   ["RH_Mk48mod1elcan",12];
			_allWeapons = _allWeapons +   ["RH_M60E4_EOTECH",12];
			_allWeapons = _allWeapons +   ["RH_MK43_ACOG",12];
			_allWeapons = _allWeapons +   ["RH_MK43_ELCAN",12];
			_allWeapons = _allWeapons +   ["RH_XM8DSAW",12];
*/
//HEAVY WEAPONS
		_allWeapons = _allWeapons +   ["M136",12];
		_allWeapons = _allWeapons +   ["SMAW",12];
		_allWeapons = _allWeapons +   ["Stinger",12];
		_allWeapons = _allWeapons +   ["JAVELIN",12];
		_allWeapons = _allWeapons +   ["M47Launcher_EP1",12];
		_allWeapons = _allWeapons +   ["MAAWS",12];
		_allWeapons = _allWeapons +   ["BAF_NLAW_Launcher",12];
//PISTOLS
		_allWeapons = _allWeapons +   ["M9",12];
//		_allWeapons = _allWeapons +   ["M9SD",12];
		_allWeapons = _allWeapons +   ["Colt1911",12];
		_allWeapons = _allWeapons +   ["glock17_EP1",12];
		_allWeapons = _allWeapons +   ["revolver_EP1",12];
//SMG
		_allWeapons = _allWeapons +   ["M1014",12];
		_allWeapons = _allWeapons +   ["AA12_PMC",12];
		_allWeapons = _allWeapons +   ["UZI_EP1",12];
		_allWeapons = _allWeapons +   ["UZI_SD_EP1",12];
		_allWeapons = _allWeapons +   ["MP5A5",12];
		_allWeapons = _allWeapons +   ["MP5SD",12];
		_allWeapons = _allWeapons +   ["G36A_camo",12];
		_allWeapons = _allWeapons +   ["G36_C_SD_eotech",12];
		_allWeapons = _allWeapons +   ["m8_compact",12];
		_allWeapons = _allWeapons +   ["G36C_camo",12];
		_allWeapons = _allWeapons +   ["G36_C_SD_camo",12];

//CARBINES
		_allWeapons = _allWeapons +   ["LeeEnfield",12];
		_allWeapons = _allWeapons +   ["FN_FAL",12];
		_allWeapons = _allWeapons +   ["M14_EP1",12];
		_allWeapons = _allWeapons +   ["M16A2",12];
		_allWeapons = _allWeapons +   ["M4A1",12];
		_allWeapons = _allWeapons +   ["M4A1_AIM_SD_camo",12];
		_allWeapons = _allWeapons +   ["M4A1_Aim_camo",12];
		_allWeapons = _allWeapons +   ["G36C",12];
		_allWeapons = _allWeapons +   ["G36K",12];
		_allWeapons = _allWeapons +   ["m8_carbine",12];
		_allWeapons = _allWeapons +   ["m8_holo_sd",12];
		_allWeapons = _allWeapons +   ["m8_compact_pmc",12];
		_allWeapons = _allWeapons +   ["G36A_camo",12];
		_allWeapons = _allWeapons +   ["G36K_camo",12];
		_allWeapons = _allWeapons +   ["M4A3_CCO_EP1",12];
		_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO",12];
		_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO_SD",12];
		_allWeapons = _allWeapons +   ["Scar_L_CQC",12];
		_allWeapons = _allWeapons +   ["Scar_L_CQC_CCO_SD",12];
		_allWeapons = _allWeapons +   ["Scar_L_CQC_Holo",12];
		_allWeapons = _allWeapons +   ["Scar_L_STD_Holo",12];
		_allWeapons = _allWeapons +   ["Scar_L_STD_Mk4CQT",12];
		_allWeapons = _allWeapons +   ["SCAR_H_STD_TWS_SD",12];
		_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_Holo",12];
//GL
		_allWeapons = _allWeapons +   ["M16A2GL",12];
		_allWeapons = _allWeapons +   ["M16A4_GL",12];
		_allWeapons = _allWeapons +   ["M16A4_ACG_GL",12];
		_allWeapons = _allWeapons +   ["M4A1_RCO_GL",12];
		_allWeapons = _allWeapons +   ["M4A1_HWS_GL_camo",12];
		_allWeapons = _allWeapons +   ["M4A1_HWS_GL_SD_Camo",12];
		_allWeapons = _allWeapons +   ["m8_carbineGL",12];
		_allWeapons = _allWeapons +   ["M4A3_RCO_GL_EP1",12];
		_allWeapons = _allWeapons +   ["SCAR_H_STD_EGLM_Spect",12];
		_allWeapons = _allWeapons +   ["SCAR_L_CQC_EGLM_Holo",12];
		_allWeapons = _allWeapons +   ["SCAR_L_STD_EGLM_RCO",12];
		_allWeapons = _allWeapons +   ["SCAR_L_STD_EGLM_TWS",12];
		_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_ACOG",12];
		_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_Holo",12];
		_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_SUSAT",12];
		_allWeapons = _allWeapons +   ["M32_EP1",12];
		_allWeapons = _allWeapons +   ["M79_EP1",12];
		_allWeapons = _allWeapons +   ["Mk13_EP1",12];
//SNIPER
		_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_ACOG",12];
		_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_CWS",12];
		_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_SUSAT",12];
		_allWeapons = _allWeapons +   ["SCAR_H_LNG_Sniper",12];
		_allWeapons = _allWeapons +   ["SCAR_H_LNG_Sniper_SD",12];
		_allWeapons = _allWeapons +   ["FN_FAL_ANPVS4",12];
		_allWeapons = _allWeapons +   ["m16a4_acg",12];
		_allWeapons = _allWeapons +   ["M4SPR",12];
		_allWeapons = _allWeapons +   ["m8_tws",12];
		_allWeapons = _allWeapons +   ["m8_tws_sd",12];
		_allWeapons = _allWeapons +   ["m8_sharpshooter",12];
		_allWeapons = _allWeapons +   ["DMR",12];
//		_allWeapons = _allWeapons +   ["M24",12];
		_allWeapons = _allWeapons +   ["M24_des_EP1",12];
		_allWeapons = _allWeapons +   ["M40A3",12];
//		_allWeapons = _allWeapons +   ["EB_M24A2",12];
		_allWeapons = _allWeapons +   ["EB_M24A2_D",12];
//		_allWeapons = _allWeapons +   ["EB_M24A3",12];
		_allWeapons = _allWeapons +   ["EB_M24A3_D",12];

		_allWeapons = _allWeapons +   ["BAF_LRR_scoped",12];
//		_allWeapons = _allWeapons +   ["BAF_LRR_scoped_W",12];
		_allWeapons = _allWeapons +   ["M107",12];
		_allWeapons = _allWeapons +   ["M107_TWS_EP1",12];
		_allWeapons = _allWeapons +   ["M110_NVG_EP1",12];
		_allWeapons = _allWeapons +   ["M110_TWS_EP1",12];
		_allWeapons = _allWeapons +   ["BAF_AS50_scoped",12];
		_allWeapons = _allWeapons +   ["BAF_AS50_TWS",12];
//MG
		_allWeapons = _allWeapons +   ["BAF_L86A2_ACOG",12];
//		_allWeapons = _allWeapons +   ["MG36",12];
		_allWeapons = _allWeapons +   ["MG36_camo",12];		
		_allWeapons = _allWeapons +   ["M249",12];
		_allWeapons = _allWeapons +   ["M249_m145_EP1",12];
		_allWeapons = _allWeapons +   ["M249_TWS_EP1",12];
		_allWeapons = _allWeapons +   ["m8_SAW",12];
		_allWeapons = _allWeapons +   ["M240",12];
		_allWeapons = _allWeapons +   ["m240_scoped_EP1",12];
		_allWeapons = _allWeapons +   ["M60A4_EP1",12];
		_allWeapons = _allWeapons +   ["BAF_L110A1_Aim",12];
//		_allWeapons = _allWeapons +   ["Mk_48",12];
		_allWeapons = _allWeapons +   ["Mk_48_DES_EP1",12];
//ammo 
//FHQ ammo
/*
...
//basics
		_allWeapons = _allWeapons +   ["huntingrifle",12];
		_allWeapons = _allWeapons +   ["Binocular",2];
		_allWeapons = _allWeapons +   ["Binocular_Vector",2];
		_allWeapons = _allWeapons +   ["NVGoggles",2];
		_allWeapons = _allWeapons +   ["Laserdesignator",2];
...
//		_vec addMagazineCargo ["BAF_L109A1_HE",12];
		...
		{
//new weapons
		_allWeapons = _allWeapons +   ["EB_BAF_LRR_scoped_O",2];
		_allWeapons = _allWeapons +   ["EB_m79p",2];
		_allWeapons = _allWeapons +   ["EB_m1911SD",2];
		_allWeapons = _allWeapons +   ["EB_MX991_w",2];
		_allWeapons = _allWeapons +   ["EB_MX991_r",2];
		_allWeapons = _allWeapons +   ["EB_MX991_g",2];
		_allWeapons = _allWeapons +   ["EB_mkvFlarePistol",2];
...
//new items
		_allWeapons = _allWeapons +   ["EB_TIscanner",2];
		_allWeapons = _allWeapons +   ["EB_TIGoggles",2];
		_allWeapons = _allWeapons +   ["EB_S10",2];
		_vec addmagazinecargo ["EB_knife",12];
		_vec addmagazinecargo ["EB_kabar",12];
		_vec addmagazinecargo ["EB_ItemFuelcanEmpty",12];
		_allWeapons = _allWeapons +   ["EB_ItemSiphon",2];
		_allWeapons = _allWeapons +   ["EB_ItemSil_hgun",12];
		_allWeapons = _allWeapons +   ["EB_ItemSil_rifle",12];
	...
	_FillAmmoBoxUR =
	{
		...
		switch (_rank) do
		{
			 ...
			 case 0:
			{
				...
				_allWeapons = _rank0Weapons;
//new stuff

				_allWeapons = _allWeapons +  ["C1987_MP7_t"];
				_allWeapons = _allWeapons +  ["ACR_SA58REF"];
				_allWeapons = _allWeapons +  ["ACR_M4A3"];
				_allWeapons = _allWeapons +  ["DM_CAMO_M4_EO_LP_FG"];
				_allWeapons = _allWeapons +  ["DM_CAMO_M4_CCO_LP_FG"];
				_allWeapons = _allWeapons +  ["R3F_Famas_F1"];
				_allWeapons = _allWeapons +  ["R3F_Famas_G2"];
//RH
				_allWeapons = _allWeapons +  ["RH_mk18"];
				_allWeapons = _allWeapons +  ["RH_Mk18aim"];

				_allWeapons = _allWeapons +  ["RH_HK53aim"];
				_allWeapons = _allWeapons +  ["RH_fmg9"];
				_allWeapons = _allWeapons +  ["RH_ar10"];
				_allWeapons = _allWeapons +  ["RH_m4sbraim"];
				_allWeapons = _allWeapons +  ["RH_m1ssp"];
				_allWeapons = _allWeapons +  ["RH_M249"];

//FHQ
//				_allWeapons = _allWeapons +  ["FHQ_ACR_WDL_IRN"];
				_allWeapons = _allWeapons +  ["FHQ_ACR_WDL_IRN_F"];
				_allWeapons = _allWeapons +  ["FHQ_ACR_WDL_CCO_F"];
				_allWeapons = _allWeapons +  ["FHQ_ACR_WDL_HWS_F"];
				_allWeapons = _allWeapons +  ["FHQ_ACR_WDL_G33_F"];
				_allWeapons = _allWeapons +  ["FHQ_ACR_WDL_IRN_GL_F"];
				_allWeapons = _allWeapons +  ["FHQ_RSASS_TAN"];				

			};
			 case 1:
			{
				_allWeapons = _allWeapons +   ["PRACS_CG"];
				_allWeapons = _allWeapons +   ["PRACS_UMP45"];
				_allWeapons = _allWeapons +   ["PRACS_HK33A4"];
				_allWeapons = _allWeapons +   ["PRACS_HK53A3"];
				_allWeapons = _allWeapons +   ["PRACS_GalilAR"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_M203"];
				_allWeapons = _allWeapons +   ["PRACS_CETME"];
				_allWeapons = _allWeapons +   ["PRACS_FNC"];
				_allWeapons = _allWeapons +   ["PRACS_M16A1"];
				_allWeapons = _allWeapons +   ["PRACS_g3a3"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4t40"];
				_allWeapons = _allWeapons +   ["PRACS_M60"];

				_allWeapons = _allWeapons +   ["M136"];
				_allWeapons = _allWeapons +   ["Stinger"];

				_allWeapons = _allWeapons +   ["Colt1911"];

				_allWeapons = _allWeapons +   ["UZI_EP1"];

				_allWeapons = _allWeapons +   ["M1014"];

				_allWeapons = _allWeapons +   ["M16A2"];
				_allWeapons = _allWeapons +   ["M16A4"];
				_allWeapons = _allWeapons +   ["M4A1"];
				_allWeapons = _allWeapons +   ["LeeEnfield"];
				_allWeapons = _allWeapons +   ["M14_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL"];

				_allWeapons = _allWeapons +   ["G36K"];
				_allWeapons = _allWeapons +   ["G36C"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_Holo"];
				_allWeapons = _allWeapons +   ["Scar_L_CQC"];
				_allWeapons = _allWeapons +   ["m8_compact"];

				_allWeapons = _allWeapons +   ["M16A2GL"];
				_allWeapons = _allWeapons +   ["M16A4_GL"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_Holo"];
				_allWeapons = _allWeapons +   ["M79_EP1"];

				_allWeapons = _allWeapons +   ["FN_FAL_ANPVS4"];
//				_allWeapons = _allWeapons +   ["M24"];
				_allWeapons = _allWeapons +   ["M24_des_EP1"];
				_allWeapons = _allWeapons +   ["M107"];

				_allWeapons = _allWeapons +   ["MG36"];
				_allWeapons = _allWeapons +   ["M249_EP1"];
				_allWeapons = _allWeapons +   ["BAF_L110A1_Aim"];
//CZ weapons
				_allWeapons = _allWeapons +   ["CZ_75_P_07_DUTY"];
				_allWeapons = _allWeapons +   ["CZ_75_D_COMPACT"];
				_allWeapons = _allWeapons +   ["Evo_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A1_ACR"];

				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_CQB"];
				

//RH
				_allWeapons = _allWeapons +   ["RH_mk18"];
				_allWeapons = _allWeapons +   ["RH_Mk18aim"];
//				_allWeapons = _allWeapons +   ["RH_mk18eot"];
//				_allWeapons = _allWeapons +   ["RH_Mk18acog"];

//				_allWeapons = _allWeapons +   ["RH_mk18sd"];
//				_allWeapons = _allWeapons +   ["RH_Mk18sdaim"];
//				_allWeapons = _allWeapons +   ["RH_Mk18sdeot"];
//				_allWeapons = _allWeapons +   ["RH_Mk18sdacog"];

				_allWeapons = _allWeapons +   ["RH_Mk18gl"];
//				_allWeapons = _allWeapons +   ["RH_Mk18glaim"];
//				_allWeapons = _allWeapons +   ["RH_Mk18gleot"];
//				_allWeapons = _allWeapons +   ["RH_mk18glacog"];

				_allWeapons = _allWeapons +   ["RH_HK53aim"];
				_allWeapons = _allWeapons +   ["RH_tmpsd"];
				_allWeapons = _allWeapons +   ["RH_fmg9"];
				_allWeapons = _allWeapons +   ["RH_ar10"];
				_allWeapons = _allWeapons +   ["RH_MK14AIM"];
				_allWeapons = _allWeapons +   ["RH_m4sbraim"];
				_allWeapons = _allWeapons +   ["RH_m1ssp"];
				_allWeapons = _allWeapons +   ["RH_m27"];
				_allWeapons = _allWeapons +   ["RH_M249"];
//new stuff
				_allWeapons = _allWeapons +   ["C1987_P99_green"];
				_allWeapons = _allWeapons +   ["C1987_MP7_t"];
				_allWeapons = _allWeapons +   ["ACR_SA58REF"];
				_allWeapons = _allWeapons +   ["ACR_M4A3"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_FG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_EOT"];
				_allWeapons = _allWeapons +   ["R3F_HK417M_AIM"];
				_allWeapons = _allWeapons +   ["ACR_M60E4"];
//FHQ
//				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_SD"];
//				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_F"];
				_allWeapons = _allWeapons +   ["FHQ_RSASS_TAN"];
			};
			case 2:
			{
				...
				_allWeapons = _allWeapons +   ["PRACS_UMP45"];
				_allWeapons = _allWeapons +   ["PRACS_HK33A4"];
				_allWeapons = _allWeapons +   ["PRACS_HK33A4_EO"];
				_allWeapons = _allWeapons +   ["PRACS_HK53A3"];
				_allWeapons = _allWeapons +   ["PRACS_GalilAR"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_SAR"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_M203"];
				_allWeapons = _allWeapons +   ["PRACS_CETME"];
				_allWeapons = _allWeapons +   ["PRACS_FNC"];
				_allWeapons = _allWeapons +   ["PRACS_FAL_I"];
				_allWeapons = _allWeapons +   ["PRACS_M16A1"];
				_allWeapons = _allWeapons +   ["PRACS_g3a3"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4SM1"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4t40"];
				_allWeapons = _allWeapons +   ["PRACS_SG1"];
				_allWeapons = _allWeapons +   ["PRACS_M60"];
				_allWeapons = _allWeapons +   ["PRACS_MAG58"];

				_allWeapons = _allWeapons +   ["M136"];
				_allWeapons = _allWeapons +   ["JAVELIN"];
				_allWeapons = _allWeapons +   ["Stinger"];
				_allWeapons = _allWeapons +   ["Colt1911"];
				_allWeapons = _allWeapons +   ["revolver_EP1"];
				_allWeapons = _allWeapons +   ["UZI_EP1"];
				_allWeapons = _allWeapons +   ["MP5A5"];
				_allWeapons = _allWeapons +   ["M1014"];
				_allWeapons = _allWeapons +   ["M16A2"];
				_allWeapons = _allWeapons +   ["M16A4"];
				_allWeapons = _allWeapons +   ["M4A1"];
				_allWeapons = _allWeapons +   ["M16A4_ACG"];
				_allWeapons = _allWeapons +   ["M4A1_Aim"];
				_allWeapons = _allWeapons +   ["LeeEnfield"];
				_allWeapons = _allWeapons +   ["M14_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL"];
				_allWeapons = _allWeapons +   ["G36A_camo"];
				_allWeapons = _allWeapons +   ["G36K"];
				_allWeapons = _allWeapons +   ["G36C"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_Holo"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_SUSAT"];
				_allWeapons = _allWeapons +   ["Scar_L_CQC"];
				_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO"];
				_allWeapons = _allWeapons +   ["m8_compact"];
				_allWeapons = _allWeapons +   ["M16A2GL"];
				_allWeapons = _allWeapons +   ["M16A4_GL"];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL"];
				_allWeapons = _allWeapons +   ["m8_carbineGL"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_Holo"];
				_allWeapons = _allWeapons +   ["M79_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL_ANPVS4"];
				_allWeapons = _allWeapons +   ["m8_sharpshooter"];
//				_allWeapons = _allWeapons +   ["M24"];
				_allWeapons = _allWeapons +   ["M24_des_EP1"];
//				_allWeapons = _allWeapons +   ["EB_M24A2"];
				_allWeapons = _allWeapons +   ["EB_M24A2_D"];
				_allWeapons = _allWeapons +   ["M107"];

				_allWeapons = _allWeapons +   ["BAF_L86A2_ACOG"];
				_allWeapons = _allWeapons +   ["MG36"];
				_allWeapons = _allWeapons +   ["M249_EP1"];
				_allWeapons = _allWeapons +   ["M240"];
				_allWeapons = _allWeapons +   ["M60A4_EP1"];
				_allWeapons = _allWeapons +   ["BAF_L110A1_Aim"];
//CZ weapons
				_allWeapons = _allWeapons +   ["CZ_75_P_07_DUTY"];
				_allWeapons = _allWeapons +   ["CZ_75_D_COMPACT"];
				_allWeapons = _allWeapons +   ["Evo_ACR"];
				_allWeapons = _allWeapons +   ["Evo_mrad_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A1_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A1_GL_ACR"];

				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_CQB"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_PF"];
...
//				_allWeapons = _allWeapons +   ["RH_mk18glacog"];
				...
				_allWeapons = _allWeapons +   ["RH_m9sd"];
				_allWeapons = _allWeapons +   ["RH_m1911sd"];
				_allWeapons = _allWeapons +   ["RH_mac10p"];
				_allWeapons = _allWeapons +   ["RH_HK53aim"];
				_allWeapons = _allWeapons +   ["RH_krisssd"];
				_allWeapons = _allWeapons +   ["RH_tmpsd"];
				_allWeapons = _allWeapons +   ["RH_fmg9"];
				_allWeapons = _allWeapons +   ["RH_PDW_AIM"];
				_allWeapons = _allWeapons +   ["RH_ar10"];
				_allWeapons = _allWeapons +   ["RH_MK14AIM"];
				_allWeapons = _allWeapons +   ["RH_m4sd"];
				_allWeapons = _allWeapons +   ["RH_m4sbraim"];
				_allWeapons = _allWeapons +   ["RH_sc2aim"];
				_allWeapons = _allWeapons +   ["RH_SCARL_MK4"];
				_allWeapons = _allWeapons +   ["RH_m16a3sgl"];
				_allWeapons = _allWeapons +   ["RH_m1ssp"];
				_allWeapons = _allWeapons +   ["RH_m27"];
				_allWeapons = _allWeapons +   ["RH_m27aim"];
				_allWeapons = _allWeapons +   ["RH_M249"];
				_allWeapons = _allWeapons +   ["RH_M249p"];
//new stuff
				_allWeapons = _allWeapons +   ["R3F_JIM_LR"];
				_allWeapons = _allWeapons +   ["ACR_CG"];
				_allWeapons = _allWeapons +   ["C1987_P99_green"];
				_allWeapons = _allWeapons +   ["ACR_GLOCK17SD"];
				_allWeapons = _allWeapons +   ["C1987_MP7_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_sd_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_zp"];
				_allWeapons = _allWeapons +   ["ACR_SD6"];
				_allWeapons = _allWeapons +   ["ACR_SA58REF"];
				_allWeapons = _allWeapons +   ["ACR_M4A3"];
				_allWeapons = _allWeapons +   ["ACR_M4A3REF"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_FG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_AIM"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_AIM_M203"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb"];
				_allWeapons = _allWeapons +   ["R3F_HK417M_AIM"];
//				_allWeapons = _allWeapons +   ["ACR_AW_308_D"];
				_allWeapons = _allWeapons +   ["ACR_M60E4"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_EOT"];

//FHQ
//				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_F"];
				_allWeapons = _allWeapons +   ["FHQ_RSASS_TAN"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_DESERT"];	
			...
			case 3:
			{
				...
				_allWeapons = _allWeapons +   ["PRACS_HK33A4_EO"];
				_allWeapons = _allWeapons +   ["PRACS_HK53A3"];
				_allWeapons = _allWeapons +   ["PRACS_HK53A3_EO"];
				_allWeapons = _allWeapons +   ["PRACS_GalilAR"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_SAR"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_M203"];
				_allWeapons = _allWeapons +   ["PRACS_CETME"];
				...
				_allWeapons = _allWeapons +   ["PRACS_M16A1"];
				_allWeapons = _allWeapons +   ["PRACS_g3a3"];
				_allWeapons = _allWeapons +   ["PRACS_g3a3t40"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4SM1"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4SM2"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4t40"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4k"];
				_allWeapons = _allWeapons +   ["PRACS_SG1"];
				_allWeapons = _allWeapons +   ["PRACS_M60"];
				_allWeapons = _allWeapons +   ["PRACS_MAG58"];
				_allWeapons = _allWeapons +   ["PRACS_Mk48"];

				_allWeapons = _allWeapons +   ["M136"];
				_allWeapons = _allWeapons +   ["JAVELIN"];
				_allWeapons = _allWeapons +   ["BAF_NLAW_Launcher"];
				_allWeapons = _allWeapons +   ["Stinger"];
				_allWeapons = _allWeapons +   ["Colt1911"];
				_allWeapons = _allWeapons +   ["revolver_EP1"];
				_allWeapons = _allWeapons +   ["UZI_EP1"];
				_allWeapons = _allWeapons +   ["UZI_SD_EP1"];
				_allWeapons = _allWeapons +   ["MP5A5"];
				_allWeapons = _allWeapons +   ["M1014"];
				_allWeapons = _allWeapons +   ["AA12_PMC"];
				_allWeapons = _allWeapons +   ["M16A2"];
				_allWeapons = _allWeapons +   ["M16A4"];
				_allWeapons = _allWeapons +   ["M4A1"];
				_allWeapons = _allWeapons +   ["M16A4_ACG"];
				_allWeapons = _allWeapons +   ["M4A1_Aim"];
				_allWeapons = _allWeapons +   ["M4A1_Aim_camo"];
				_allWeapons = _allWeapons +   ["LeeEnfield"];
				_allWeapons = _allWeapons +   ["M14_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL"];
				_allWeapons = _allWeapons +   ["G36A_camo"];
				_allWeapons = _allWeapons +   ["G36K"];
				_allWeapons = _allWeapons +   ["G36C"];
				_allWeapons = _allWeapons +   ["G36C_camo"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_Holo"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_SUSAT"];
				_allWeapons = _allWeapons +   ["Scar_L_CQC"];
				_allWeapons = _allWeapons +   ["Scar_L_CQC_Holo"];
				_allWeapons = _allWeapons +   ["Scar_L_STD_Holo"];
				_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO"];
				_allWeapons = _allWeapons +   ["m8_compact"];
				_allWeapons = _allWeapons +   ["m8_carbine"];
				_allWeapons = _allWeapons +   ["M16A2GL"];
				_allWeapons = _allWeapons +   ["M16A4_GL"];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL"];
				_allWeapons = _allWeapons +   ["M4A1_RCO_GL"];
				_allWeapons = _allWeapons +   ["M4A3_RCO_GL_EP1"];
				_allWeapons = _allWeapons +   ["M4A3_CCO_EP1"];
				_allWeapons = _allWeapons +   ["m8_carbineGL"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_Holo"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_SUSAT"];
				_allWeapons = _allWeapons +   ["M79_EP1"];
				_allWeapons = _allWeapons +   ["Mk13_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL_ANPVS4"];
				_allWeapons = _allWeapons +   ["m8_sharpshooter"];
//				_allWeapons = _allWeapons +   ["M24"];
				_allWeapons = _allWeapons +   ["M24_des_EP1"];
//				_allWeapons = _allWeapons +   ["EB_M24A2"];
				_allWeapons = _allWeapons +   ["EB_M24A2_D"];
//				_allWeapons = _allWeapons +   ["EB_M24A3"];
				_allWeapons = _allWeapons +   ["EB_M24A3_D"];
				_allWeapons = _allWeapons +   ["M40A3"];
				_allWeapons = _allWeapons +   ["BAF_LRR_scoped"];
//				_allWeapons = _allWeapons +   ["BAF_LRR_scoped_W"];
				_allWeapons = _allWeapons +   ["M107"];
				_allWeapons = _allWeapons +   ["M110_NVG_EP1"];
				_allWeapons = _allWeapons +   ["BAF_L86A2_ACOG"];
				_allWeapons = _allWeapons +   ["MG36"];
				_allWeapons = _allWeapons +   ["M249_EP1"];
				_allWeapons = _allWeapons +   ["m8_SAW"];
				_allWeapons = _allWeapons +   ["M240"];
				_allWeapons = _allWeapons +   ["m240_scoped_EP1"];
				_allWeapons = _allWeapons +   ["M60A4_EP1"];
				_allWeapons = _allWeapons +   ["BAF_L110A1_Aim"];
//CZ weapons
				_allWeapons = _allWeapons +   ["CZ_75_P_07_DUTY"];
				_allWeapons = _allWeapons +   ["CZ_75_D_COMPACT"];
				_allWeapons = _allWeapons +   ["CZ_75_SP_01_PHANTOM"];
				_allWeapons = _allWeapons +   ["Evo_ACR"];
				_allWeapons = _allWeapons +   ["Evo_mrad_ACR"];
				_allWeapons = _allWeapons +   ["UK59_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A1_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A1_GL_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A2_ACR"];
				_allWeapons = _allWeapons +   ["LRTV_ACR"];

				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_HG"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_CQB"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_PF"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_UGL_PF"];
...
//				_allWeapons = _allWeapons +   ["RH_mk18glacog"];
				...
				_allWeapons = _allWeapons +   ["RH_m93r"];
				_allWeapons = _allWeapons +   ["RH_p226"];
				_allWeapons = _allWeapons +   ["RH_m9sd"];
				_allWeapons = _allWeapons +   ["RH_m1911sd"];
				_allWeapons = _allWeapons +   ["RH_anac"];
				_allWeapons = _allWeapons +   ["RH_mac10p"];
				_allWeapons = _allWeapons +   ["RH_HK53aim"];
				_allWeapons = _allWeapons +   ["RH_umpsd"];
				_allWeapons = _allWeapons +   ["RH_krisssd"];
				_allWeapons = _allWeapons +   ["RH_tmpsd"];
				_allWeapons = _allWeapons +   ["RH_fmg9"];
				_allWeapons = _allWeapons +   ["RH_pdreot"];
				_allWeapons = _allWeapons +   ["RH_PDW_AIM"];
				_allWeapons = _allWeapons +   ["RH_M4CMKEOTECH"];
				_allWeapons = _allWeapons +   ["RH_ar10"];
				_allWeapons = _allWeapons +   ["RH_ar10s"];
				_allWeapons = _allWeapons +   ["RH_MK14AIM"];
				_allWeapons = _allWeapons +   ["RH_m16a3cs"];
				_allWeapons = _allWeapons +   ["RH_m4a1eotech"];
				_allWeapons = _allWeapons +   ["RH_m4sd"];
				_allWeapons = _allWeapons +   ["RH_m4sbraim"];
				_allWeapons = _allWeapons +   ["RH_sc2aim"];
				_allWeapons = _allWeapons +   ["RH_SCARL_MK4"];
				_allWeapons = _allWeapons +   ["RH_SCARH_MK4"];
				_allWeapons = _allWeapons +   ["RH_m16a3sgl"];
				_allWeapons = _allWeapons +   ["RH_m16a4gleotech"];
				_allWeapons = _allWeapons +   ["RH_M4sdgleotech_wdl"];
				_allWeapons = _allWeapons +   ["RH_M4CTSDGLACOG_F"];
				_allWeapons = _allWeapons +   ["RH_m1ssp"];
				_allWeapons = _allWeapons +   ["RH_M14EBRSP"];
				_allWeapons = _allWeapons +   ["RH_m27"];
				_allWeapons = _allWeapons +   ["RH_m27aim"];
				_allWeapons = _allWeapons +   ["RH_m21"];
				_allWeapons = _allWeapons +   ["RH_M249"];
				_allWeapons = _allWeapons +   ["RH_M249p"];
				_allWeapons = _allWeapons +   ["RH_XM8DSAW"];
...
//new stuff
				...
				_allWeapons = _allWeapons +   ["C1987_MP7_sd_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_zp"];
				_allWeapons = _allWeapons +   ["C1987_MP7_eot"];
				_allWeapons = _allWeapons +   ["ACR_SD6"];
				_allWeapons = _allWeapons +   ["ACR_SA58REF"];
				_allWeapons = _allWeapons +   ["ACR_M4A3"];
				_allWeapons = _allWeapons +   ["ACR_M4A3REF"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_SIL_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_FG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_AIM"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_J4_M203"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_J4_HG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_AIM_M203"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_AIM_HG"];
				_allWeapons = _allWeapons +   ["R3F_HK417M_AIM"];
				_allWeapons = _allWeapons +   ["R3F_HK417S_HG_SD"];
				_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II"];
//				_allWeapons = _allWeapons +   ["ACR_AW_308_D"];
				_allWeapons = _allWeapons +   ["ACR_M60E4"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_762_EOT_HG"];
//FHQ
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_F"];
				...
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_RSASS_TAN"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_NV_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_NV_DESERT"];
			 ...
			 case 4:
			{
				...
				_allWeapons = _allWeapons +   ["PRACS_GalilAR"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_SAR"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_SUIT"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_M203"];
				_allWeapons = _allWeapons +   ["PRACS_CETME"];
				_allWeapons = _allWeapons +   ["PRACS_FNC"];
				_allWeapons = _allWeapons +   ["PRACS_FAL_I"];
				...
				_allWeapons = _allWeapons +   ["PRACS_g3a4t40"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4k"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4_M68"];
				_allWeapons = _allWeapons +   ["PRACS_SG1"];
				_allWeapons = _allWeapons +   ["PRACS_SG1_NVS"];
				_allWeapons = _allWeapons +   ["PRACS_M60"];
				_allWeapons = _allWeapons +   ["PRACS_MAG58"];
				_allWeapons = _allWeapons +   ["PRACS_Mk48"];
				...
				_allWeapons = _allWeapons +   ["AA12_PMC",12];
				_allWeapons = _allWeapons +   ["M16A2",12];
				_allWeapons = _allWeapons +   ["M16A4",12];
				_allWeapons = _allWeapons +   ["M4A1",12];
				_allWeapons = _allWeapons +   ["M16A4_ACG",12];
				_allWeapons = _allWeapons +   ["M4A1_Aim",12];
				_allWeapons = _allWeapons +   ["M4A1_Aim_camo",12];
				_allWeapons = _allWeapons +   ["M4A1_AIM_SD_camo",12];
				_allWeapons = _allWeapons +   ["LeeEnfield",12];
				_allWeapons = _allWeapons +   ["M14_EP1",12];
				...
				_allWeapons = _allWeapons +   ["M16A2GL",12];
				_allWeapons = _allWeapons +   ["M16A4_GL",12];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL",12];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL_camo",12];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL_SD_Camo",12];
				_allWeapons = _allWeapons +   ["M4A1_RCO_GL",12];
				_allWeapons = _allWeapons +   ["M4A3_RCO_GL_EP1",12];
...
//				_allWeapons = _allWeapons +   ["BAF_LRR_scoped_W",12];
				...
				_allWeapons = _allWeapons +   ["MG36",12];
				_allWeapons = _allWeapons +   ["MG36_camo",12];		
				_allWeapons = _allWeapons +   ["M249_EP1",12];
				_allWeapons = _allWeapons +   ["M249_m145_EP1",12];
				_allWeapons = _allWeapons +   ["m8_SAW",12];
				_allWeapons = _allWeapons +   ["M240",12];
				_allWeapons = _allWeapons +   ["m240_scoped_EP1",12];
...
*/
			 ...
			 case 5:
			{
				...
				_allWeapons = _allWeapons +   ["PRACS_Galil_SUIT"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_M203"];
				_allWeapons = _allWeapons +   ["PRACS_Galil_M203_SUIT"];
				_allWeapons = _allWeapons +   ["PRACS_CETME"];
				_allWeapons = _allWeapons +   ["PRACS_FNC"];
				_allWeapons = _allWeapons +   ["PRACS_FAL_I"];
				_allWeapons = _allWeapons +   ["PRACS_M16A1"];
				_allWeapons = _allWeapons +   ["PRACS_M16A1_NVS"];
				_allWeapons = _allWeapons +   ["PRACS_g3a3"];
				_allWeapons = _allWeapons +   ["PRACS_g3a3t40"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4SM1"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4SM2"];
				...
				_allWeapons = _allWeapons +   ["PRACS_g3a4k"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4_M68"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4sp"];
				_allWeapons = _allWeapons +   ["PRACS_SG1"];
				_allWeapons = _allWeapons +   ["PRACS_SG1_SD"];
				_allWeapons = _allWeapons +   ["PRACS_SG1_NVS"];
				_allWeapons = _allWeapons +   ["PRACS_M60"];
				_allWeapons = _allWeapons +   ["PRACS_MAG58"];
				_allWeapons = _allWeapons +   ["PRACS_Mk48"];
				_allWeapons = _allWeapons +   ["PRACS_Mk48_SP"];

				_allWeapons = _allWeapons +   ["M136"];
				_allWeapons = _allWeapons +   ["SMAW"];
				_allWeapons = _allWeapons +   ["JAVELIN"];
				_allWeapons = _allWeapons +   ["BAF_NLAW_Launcher"];
				_allWeapons = _allWeapons +   ["MAAWS"];
				_allWeapons = _allWeapons +   ["Stinger"];
				_allWeapons = _allWeapons +   ["M9SD"];
				_allWeapons = _allWeapons +   ["Colt1911"];
				_allWeapons = _allWeapons +   ["glock17_EP1"];
				_allWeapons = _allWeapons +   ["revolver_EP1"];
				_allWeapons = _allWeapons +   ["UZI_EP1"];
				_allWeapons = _allWeapons +   ["UZI_SD_EP1"];
				_allWeapons = _allWeapons +   ["MP5A5"];
				_allWeapons = _allWeapons +   ["MP5SD"];
				_allWeapons = _allWeapons +   ["M1014"];
				_allWeapons = _allWeapons +   ["AA12_PMC"];
				_allWeapons = _allWeapons +   ["M16A2"];
				_allWeapons = _allWeapons +   ["M16A4"];
				...
				_allWeapons = _allWeapons +   ["M4A1_Aim"];
				_allWeapons = _allWeapons +   ["M4A1_Aim_camo"];
				_allWeapons = _allWeapons +   ["M4A1_AIM_SD_camo"];
				_allWeapons = _allWeapons +   ["LeeEnfield"];
				_allWeapons = _allWeapons +   ["M14_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL"];
				_allWeapons = _allWeapons +   ["G36A_camo"];
				...
				_allWeapons = _allWeapons +   ["G36C"];
				_allWeapons = _allWeapons +   ["G36C_camo"];
				_allWeapons = _allWeapons +   ["G36_C_SD_camo"];
				_allWeapons = _allWeapons +   ["G36_C_SD_eotech"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_Holo"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_SUSAT"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_ACOG"];
				_allWeapons = _allWeapons +   ["Scar_L_CQC"];
				_allWeapons = _allWeapons +   ["Scar_L_CQC_CCO_SD"];
				_allWeapons = _allWeapons +   ["Scar_L_CQC_Holo"];
				_allWeapons = _allWeapons +   ["Scar_L_STD_Holo"];
				_allWeapons = _allWeapons +   ["Scar_L_STD_Mk4CQT"];
				_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO"];
				_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO_SD"];
				_allWeapons = _allWeapons +   ["m8_holo_sd"];
				_allWeapons = _allWeapons +   ["m8_compact_pmc"];
				_allWeapons = _allWeapons +   ["m8_compact"];
				_allWeapons = _allWeapons +   ["m8_carbine"];
				_allWeapons = _allWeapons +   ["M16A2GL"];
				_allWeapons = _allWeapons +   ["M16A4_GL"];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL"];
				_allWeapons = _allWeapons +   ["M16A4_ACG_GL"];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL_camo"];
				_allWeapons = _allWeapons +   ["M4A1_HWS_GL_SD_Camo"];
				_allWeapons = _allWeapons +   ["M4A1_RCO_GL"];
				_allWeapons = _allWeapons +   ["M4A3_RCO_GL_EP1"];
				_allWeapons = _allWeapons +   ["M4A3_CCO_EP1"];
				_allWeapons = _allWeapons +   ["m8_carbineGL"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_Holo"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_SUSAT"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_UGL_ACOG"];
				_allWeapons = _allWeapons +   ["SCAR_H_STD_EGLM_Spect"];
				_allWeapons = _allWeapons +   ["SCAR_L_CQC_EGLM_Holo"];
				_allWeapons = _allWeapons +   ["SCAR_L_STD_EGLM_RCO"];
				_allWeapons = _allWeapons +   ["M79_EP1"];
				_allWeapons = _allWeapons +   ["Mk13_EP1"];
				_allWeapons = _allWeapons +   ["M32_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL_ANPVS4"];
				_allWeapons = _allWeapons +   ["M4SPR"];
				_allWeapons = _allWeapons +   ["m8_sharpshooter"];
				_allWeapons = _allWeapons +   ["m8_tws"];
				_allWeapons = _allWeapons +   ["m8_tws_sd"];
				_allWeapons = _allWeapons +   ["DMR"];
//				_allWeapons = _allWeapons +   ["M24"];
				_allWeapons = _allWeapons +   ["M24_des_EP1"];
//				_allWeapons = _allWeapons +   ["EB_M24A2"];
				_allWeapons = _allWeapons +   ["EB_M24A2_D"];
...
//				_allWeapons = _allWeapons +   ["BAF_LRR_scoped_W"];
				_allWeapons = _allWeapons +   ["M107"];
				_allWeapons = _allWeapons +   ["BAF_AS50_scoped"];
				_allWeapons = _allWeapons +   ["BAF_AS50_TWS"];
				_allWeapons = _allWeapons +   ["SCAR_H_LNG_Sniper"];
				_allWeapons = _allWeapons +   ["SCAR_H_LNG_Sniper_SD"];
				_allWeapons = _allWeapons +   ["M110_NVG_EP1"];
				_allWeapons = _allWeapons +   ["M110_TWS_EP1"];
				_allWeapons = _allWeapons +   ["BAF_L86A2_ACOG"];
				_allWeapons = _allWeapons +   ["MG36"];
				_allWeapons = _allWeapons +   ["MG36_camo"];		
				_allWeapons = _allWeapons +   ["M249_EP1"];
				_allWeapons = _allWeapons +   ["M249_m145_EP1"];
				_allWeapons = _allWeapons +   ["M249_TWS_EP1"];
				_allWeapons = _allWeapons +   ["m8_SAW"];
				_allWeapons = _allWeapons +   ["M240"];
				_allWeapons = _allWeapons +   ["m240_scoped_EP1"];
				_allWeapons = _allWeapons +   ["M60A4_EP1"];
				_allWeapons = _allWeapons +   ["BAF_L110A1_Aim"];
//				_allWeapons = _allWeapons +   ["Mk_48"];
				_allWeapons = _allWeapons +   ["Mk_48_DES_EP1"];
//CZ weapons
				_allWeapons = _allWeapons +   ["CZ_75_P_07_DUTY"];
				_allWeapons = _allWeapons +   ["CZ_75_D_COMPACT"];
				_allWeapons = _allWeapons +   ["CZ_75_SP_01_PHANTOM"];
				_allWeapons = _allWeapons +   ["CZ_75_SP_01_PHANTOM_SD"];
				_allWeapons = _allWeapons +   ["Evo_ACR"];
				_allWeapons = _allWeapons +   ["Evo_mrad_ACR"];
				_allWeapons = _allWeapons +   ["evo_sd_ACR"];
				_allWeapons = _allWeapons +   ["UK59_ACR"];
				_allWeapons = _allWeapons +   ["CZ_750_S1_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A1_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A1_GL_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A2_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_B_GL_ACR"];
				_allWeapons = _allWeapons +   ["LRTV_ACR"];

				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_HG"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_UGL_PF"];

				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_CQB"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_CQB_SD"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_PF"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_PF_SD"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_EOT_UGL_PF"];
...
//				_allWeapons = _allWeapons +   ["RH_mk18glacog"];
				...
				_allWeapons = _allWeapons +   ["RH_m93r"];
				_allWeapons = _allWeapons +   ["RH_p226"];
				_allWeapons = _allWeapons +   ["RH_g18"];
				_allWeapons = _allWeapons +   ["RH_mk22vsd"];
				_allWeapons = _allWeapons +   ["RH_uspsd"];
				_allWeapons = _allWeapons +   ["RH_m9sd"];
				_allWeapons = _allWeapons +   ["RH_m1911sd"];
				_allWeapons = _allWeapons +   ["RH_anac"];
				_allWeapons = _allWeapons +   ["RH_bull"];
				_allWeapons = _allWeapons +   ["RH_python"];
				_allWeapons = _allWeapons +   ["RH_pp2000p"];
				_allWeapons = _allWeapons +   ["RH_mac10p"];
				_allWeapons = _allWeapons +   ["RH_tec9"];
				_allWeapons = _allWeapons +   ["RH_mp5kp"];
				_allWeapons = _allWeapons +   ["RH_HK53aim"];
				_allWeapons = _allWeapons +   ["RH_mp5a4rfx"];
				_allWeapons = _allWeapons +   ["RH_mp5a5ris"];
				_allWeapons = _allWeapons +   ["RH_mp5sd6eot"];
				_allWeapons = _allWeapons +   ["RH_P90isd"];
				_allWeapons = _allWeapons +   ["RH_umpsd"];
				_allWeapons = _allWeapons +   ["RH_umpsdaim"];
				_allWeapons = _allWeapons +   ["RH_krisssd"];
				_allWeapons = _allWeapons +   ["RH_krisssdeot"];
				_allWeapons = _allWeapons +   ["RH_uzisd"];
				_allWeapons = _allWeapons +   ["RH_tmpsd"];
				_allWeapons = _allWeapons +   ["RH_pp2000eot"];
				_allWeapons = _allWeapons +   ["RH_mp7sdaim"];
				_allWeapons = _allWeapons +   ["RH_fmg9"];
				_allWeapons = _allWeapons +   ["RH_pdreot"];
				_allWeapons = _allWeapons +   ["RH_PDW_AIM"];
				_allWeapons = _allWeapons +   ["RH_M4CMKEOTECH"];
				...
				_allWeapons = _allWeapons +   ["RH_ar10s"];
				_allWeapons = _allWeapons +   ["RH_MK14AIM"];
				_allWeapons = _allWeapons +   ["RH_MK14SDEOTECH"];
				_allWeapons = _allWeapons +   ["RH_m16a3cs"];
				_allWeapons = _allWeapons +   ["RH_m4a1eotech"];
				_allWeapons = _allWeapons +   ["RH_m4sd"];
				_allWeapons = _allWeapons +   ["RH_M4sdaim_wdl"];
				_allWeapons = _allWeapons +   ["RH_m4sbraim"];
				_allWeapons = _allWeapons +   ["RH_sc2aim"];
				_allWeapons = _allWeapons +   ["RH_SCARL_MK4"];
				_allWeapons = _allWeapons +   ["RH_SCARH_MK4"];
				_allWeapons = _allWeapons +   ["RH_SCARH_SD_ACOG"];
				_allWeapons = _allWeapons +   ["RH_m16a3sgl"];
				_allWeapons = _allWeapons +   ["RH_m16a4gleotech"];
				_allWeapons = _allWeapons +   ["RH_M4sdgleotech_wdl"];
				_allWeapons = _allWeapons +   ["RH_M4CTSDGLACOG_F"];
				_allWeapons = _allWeapons +   ["RH_SCARH_GL_EOTECH"];
				_allWeapons = _allWeapons +   ["RH_SCARLB_SD_GL_AIM"];
				_allWeapons = _allWeapons +   ["RH_SCARL_GL_EOTECH"];
				_allWeapons = _allWeapons +   ["RH_m1ssp"];
				_allWeapons = _allWeapons +   ["RH_M14EBRSP"];
				_allWeapons = _allWeapons +   ["RH_mk14ebrsp_sd"];
				_allWeapons = _allWeapons +   ["RH_mk12sd"];
				_allWeapons = _allWeapons +   ["RH_m27"];
				_allWeapons = _allWeapons +   ["RH_m27aim"];
				_allWeapons = _allWeapons +   ["RH_m27cacog"];
				_allWeapons = _allWeapons +   ["RH_m27ceotech"];
				_allWeapons = _allWeapons +   ["RH_m21"];
				_allWeapons = _allWeapons +   ["RH_M249"];
				_allWeapons = _allWeapons +   ["RH_M249p"];
				_allWeapons = _allWeapons +   ["RH_M249pelcan"];
				_allWeapons = _allWeapons +   ["RH_Mk48mod1"];
				_allWeapons = _allWeapons +   ["RH_M60E4_EOTECH"];
				_allWeapons = _allWeapons +   ["RH_MK43_ELCAN"];
				_allWeapons = _allWeapons +   ["RH_XM8DSAW"];
//new stuff
				_allWeapons = _allWeapons +   ["R3F_JIM_LR"];
				_allWeapons = _allWeapons +   ["ACR_CG"];
				_allWeapons = _allWeapons +   ["R3F_AT4CS"];
				_allWeapons = _allWeapons +   ["C1987_P99_green"];
				_allWeapons = _allWeapons +   ["C1987_P99_green_sd"];
				_allWeapons = _allWeapons +   ["C1987_P99_green_laser"];
				_allWeapons = _allWeapons +   ["ACR_GLOCK17SD"];
				_allWeapons = _allWeapons +   ["C1987_MP7_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_sd_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_zp"];
				_allWeapons = _allWeapons +   ["C1987_MP7_zp_sd_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_eot"];
				_allWeapons = _allWeapons +   ["C1987_MP7_eot_sd_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_acog_t"];
				_allWeapons = _allWeapons +   ["ACR_SD6"];
				_allWeapons = _allWeapons +   ["ACR_SA58REF"];
				_allWeapons = _allWeapons +   ["ACR_SA58ACOG"];
				_allWeapons = _allWeapons +   ["ACR_M4A3"];
				_allWeapons = _allWeapons +   ["ACR_M4A3REF"];
				_allWeapons = _allWeapons +   ["ACR_M4A3ACOG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_SIL_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_LP_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_EO_IR_SIL_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR_SIL_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_LP_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_CCO_IR_SIL_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_SIL_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_GL"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT_HG_SD"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_AIM"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_J4_M203"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_J4_M203_SD"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_J4_HG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_AIM_M203"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_EOT_SD"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_AIM_HG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_AIM_SD"];
				_allWeapons = _allWeapons +   ["R3F_HK417M_AIM"];
				_allWeapons = _allWeapons +   ["R3F_HK417S_EOT_HG"];
				_allWeapons = _allWeapons +   ["R3F_HK417S_HG_SD"];
				_allWeapons = _allWeapons +   ["R3F_FRF2_J8"];
				_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II"];
				_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II_MILDOT"];
//				_allWeapons = _allWeapons +   ["ACR_AW_308_D"];
				_allWeapons = _allWeapons +   ["ACR_M60E4"];
				_allWeapons = _allWeapons +   ["ACR_M60E4M1"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_J4"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_762_J4"];
				_allWeapons = _allWeapons +   ["R3F_minimi_AIM_HG"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_762_EOT_HG"];
//FHQ
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_F"];
				...
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_CCO_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_RCO_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HWS_GL_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_G33_GL_SD"];

				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_SD"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_GL_F"];
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_HAMR_GL_SD"];
		
				_allWeapons = _allWeapons +   ["FHQ_RSASS_TAN"];
				_allWeapons = _allWeapons +   ["FHQ_RSASS_TWS_TAN"];
				_allWeapons = _allWeapons +   ["FHQ_RSASS_SD_TAN"];

				_allWeapons = _allWeapons +   ["FHQ_XM2010_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_SD_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_NV_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_NV_SD_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_TWS_DESERT"];

				_allWeapons = _allWeapons +   ["FHQ_MSR_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_NV_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_TWS_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_SD_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_NV_SD_DESERT"];
			 ...
			 case 6:
			{
				...
				_allWeapons = _allWeapons +   ["PRACS_g3a4_M68"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4sp"];
				_allWeapons = _allWeapons +   ["PRACS_g3a4F1"];
				_allWeapons = _allWeapons +   ["PRACS_SG1"];
				_allWeapons = _allWeapons +   ["PRACS_SG1_SD"];
				_allWeapons = _allWeapons +   ["PRACS_SG1_NVS"];
				_allWeapons = _allWeapons +   ["PRACS_SG1_SD_NVS"];
				_allWeapons = _allWeapons +   ["PRACS_M60"];
				_allWeapons = _allWeapons +   ["PRACS_MAG58"];
				_allWeapons = _allWeapons +   ["PRACS_Mk48"];
				_allWeapons = _allWeapons +   ["PRACS_Mk48_SP"];
				_allWeapons = _allWeapons +   ["PRACS_Mk48_SD"];

				_allWeapons = _allWeapons +   ["M136"];
				_allWeapons = _allWeapons +   ["SMAW"];
				_allWeapons = _allWeapons +   ["JAVELIN"];
				_allWeapons = _allWeapons +   ["M47Launcher_EP1"];
				_allWeapons = _allWeapons +   ["BAF_NLAW_Launcher"];
				_allWeapons = _allWeapons +   ["MAAWS"];
				_allWeapons = _allWeapons +   ["Stinger"];
				_allWeapons = _allWeapons +   ["M9SD"];
				...
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_Holo"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_SUSAT"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_CWS"];
				_allWeapons = _allWeapons +   ["BAF_L85A2_RIS_ACOG"];
				...
				_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO"];
				_allWeapons = _allWeapons +   ["Scar_H_CQC_CCO_SD"];
				_allWeapons = _allWeapons +   ["SCAR_H_STD_TWS_SD"];
				_allWeapons = _allWeapons +   ["m8_holo_sd"];
				_allWeapons = _allWeapons +   ["m8_compact_pmc"];
				_allWeapons = _allWeapons +   ["m8_compact"];
				_allWeapons = _allWeapons +   ["m8_carbine"];
				...
				_allWeapons = _allWeapons +   ["SCAR_L_CQC_EGLM_Holo"];
				_allWeapons = _allWeapons +   ["SCAR_L_STD_EGLM_RCO"];
				_allWeapons = _allWeapons +   ["SCAR_L_STD_EGLM_TWS"];
				_allWeapons = _allWeapons +   ["M79_EP1"];
				_allWeapons = _allWeapons +   ["Mk13_EP1"];
				_allWeapons = _allWeapons +   ["M32_EP1"];
				_allWeapons = _allWeapons +   ["FN_FAL_ANPVS4"];
...
//				_allWeapons = _allWeapons +   ["BAF_LRR_scoped_W"];
				_allWeapons = _allWeapons +   ["M107"];
				_allWeapons = _allWeapons +   ["M107_TWS_EP1"];
				_allWeapons = _allWeapons +   ["BAF_AS50_scoped"];
				_allWeapons = _allWeapons +   ["BAF_AS50_TWS"];
				_allWeapons = _allWeapons +   ["SCAR_H_LNG_Sniper"];
				_allWeapons = _allWeapons +   ["SCAR_H_LNG_Sniper_SD"];
...
//CZ weapons
				...
				_allWeapons = _allWeapons +   ["CZ805_A1_GL_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A2_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_A2_SD_ACR"];
				_allWeapons = _allWeapons +   ["CZ805_B_GL_ACR"];
				_allWeapons = _allWeapons +   ["LRTV_ACR"];

//				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_HG"];
//				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_CQB"];
//				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_CQB_SD"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_CQB_SD_HG"];
//				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_PF_SD"];
//				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_UGL"];
				_allWeapons = _allWeapons +   ["LEN_L119A1_Acog_UGL_PF"];
...
//				_allWeapons = _allWeapons +   ["RH_Mk18glaim"];
				...
				_allWeapons = _allWeapons +   ["RH_p226"];
				_allWeapons = _allWeapons +   ["RH_g18"];
				_allWeapons = _allWeapons +   ["RH_g19t"];
				_allWeapons = _allWeapons +   ["RH_mk22vsd"];
				_allWeapons = _allWeapons +   ["RH_uspsd"];
				_allWeapons = _allWeapons +   ["RH_m9sd"];
				_allWeapons = _allWeapons +   ["RH_m1911sd"];
				...
				_allWeapons = _allWeapons +   ["RH_bull"];
				_allWeapons = _allWeapons +   ["RH_python"];
				_allWeapons = _allWeapons +   ["RH_deagle"];
				_allWeapons = _allWeapons +   ["RH_pp2000p"];
				_allWeapons = _allWeapons +   ["RH_mac10p"];
				_allWeapons = _allWeapons +   ["RH_tec9"];
				_allWeapons = _allWeapons +   ["RH_mp5kp"];
				_allWeapons = _allWeapons +   ["RH_mp7p"];
				_allWeapons = _allWeapons +   ["RH_HK53aim"];
				_allWeapons = _allWeapons +   ["RH_mp5a4rfx"];
				_allWeapons = _allWeapons +   ["RH_mp5a5ris"];
				_allWeapons = _allWeapons +   ["RH_mp5a5eodRFX"];
				_allWeapons = _allWeapons +   ["RH_mp5sd6eot"];
				_allWeapons = _allWeapons +   ["RH_P90isd"];
				_allWeapons = _allWeapons +   ["RH_p90sdaim"];
				_allWeapons = _allWeapons +   ["RH_umpsd"];
				_allWeapons = _allWeapons +   ["RH_umpsdaim"];
				_allWeapons = _allWeapons +   ["RH_krisssd"];
				_allWeapons = _allWeapons +   ["RH_krisssdeot"];
				_allWeapons = _allWeapons +   ["RH_uzisd"];
				_allWeapons = _allWeapons +   ["RH_tmpsd"];
				_allWeapons = _allWeapons +   ["RH_tmpsdaim"];
				_allWeapons = _allWeapons +   ["RH_pp2000eot"];
				_allWeapons = _allWeapons +   ["RH_mp7sdaim"];
				_allWeapons = _allWeapons +   ["RH_fmg9"];
				_allWeapons = _allWeapons +   ["RH_pdreot"];
				_allWeapons = _allWeapons +   ["RH_PDW_AIM"];
				_allWeapons = _allWeapons +   ["RH_M4CMKEOTECH"];
				_allWeapons = _allWeapons +   ["RH_M4CMKACOG"];
				_allWeapons = _allWeapons +   ["RH_ar10"];
				_allWeapons = _allWeapons +   ["RH_ar10s"];
				_allWeapons = _allWeapons +   ["RH_MK14AIM"];
				_allWeapons = _allWeapons +   ["RH_MK14SDEOTECH"];
				...
				_allWeapons = _allWeapons +   ["RH_M4sdaim_wdl"];
				_allWeapons = _allWeapons +   ["RH_m4sbraim"];
				_allWeapons = _allWeapons +   ["RH_M4CTSD_F"];
				_allWeapons = _allWeapons +   ["RH_sc2aim"];
				_allWeapons = _allWeapons +   ["RH_sc2shd"];
				_allWeapons = _allWeapons +   ["RH_SCARL_MK4"];
				_allWeapons = _allWeapons +   ["RH_SCARL_SD_DOC"];
				_allWeapons = _allWeapons +   ["RH_SCARLB_SD_EOTECH"];
				_allWeapons = _allWeapons +   ["RH_SCARH_MK4"];
				_allWeapons = _allWeapons +   ["RH_SCARH_SD_ACOG"];
				_allWeapons = _allWeapons +   ["RH_m16a3sgl"];
				_allWeapons = _allWeapons +   ["RH_m16a4gleotech"];
				_allWeapons = _allWeapons +   ["RH_M4sdgleotech_wdl"];
				_allWeapons = _allWeapons +   ["RH_M4CTSDGLACOG_F"];
				_allWeapons = _allWeapons +   ["RH_XM8DGL"];
				_allWeapons = _allWeapons +   ["RH_SCARH_GL_EOTECH"];
				_allWeapons = _allWeapons +   ["RH_SCARH_GL_SPECTERDR"];
				_allWeapons = _allWeapons +   ["RH_SCARLB_SD_GL_AIM"];
				_allWeapons = _allWeapons +   ["RH_SCARL_GL_EOTECH"];
				_allWeapons = _allWeapons +   ["RH_SCARLB_GL_ACOG"];
				_allWeapons = _allWeapons +   ["RH_m1ssp"];
				_allWeapons = _allWeapons +   ["RH_M14EBRSP"];
				_allWeapons = _allWeapons +   ["RH_mk14ebrsp_sd"];
				_allWeapons = _allWeapons +   ["RH_m39emr"];
				_allWeapons = _allWeapons +   ["RH_mk12sd"];
				_allWeapons = _allWeapons +   ["RH_m27"];
				_allWeapons = _allWeapons +   ["RH_m27aim"];
				_allWeapons = _allWeapons +   ["RH_m27cacog"];
				_allWeapons = _allWeapons +   ["RH_m27ceotech"];
				_allWeapons = _allWeapons +   ["RH_m21"];
				_allWeapons = _allWeapons +   ["RH_MK21A5SD"];
				_allWeapons = _allWeapons +   ["RH_M249"];
				_allWeapons = _allWeapons +   ["RH_M249p"];
				_allWeapons = _allWeapons +   ["RH_M249pelcan"];
				_allWeapons = _allWeapons +   ["RH_Mk48mod1"];
				_allWeapons = _allWeapons +   ["RH_Mk48mod1acog"];
				_allWeapons = _allWeapons +   ["RH_M60E4_EOTECH"];
				_allWeapons = _allWeapons +   ["RH_MK43_ACOG"];
				_allWeapons = _allWeapons +   ["RH_MK43_ELCAN"];
				_allWeapons = _allWeapons +   ["RH_XM8DSAW"];
//new stuff
				_allWeapons = _allWeapons +   ["R3F_JIM_LR"];
				...
				_allWeapons = _allWeapons +   ["C1987_P99_green_sd"];
				_allWeapons = _allWeapons +   ["C1987_P99_green_laser"];
				_allWeapons = _allWeapons +   ["C1987_P99_green_laser_sd"];
				_allWeapons = _allWeapons +   ["ACR_GLOCK17SD"];
				_allWeapons = _allWeapons +   ["C1987_MP7_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_sd_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_zp"];
				...
				_allWeapons = _allWeapons +   ["C1987_MP7_eot_sd_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_acog_t"];
				_allWeapons = _allWeapons +   ["C1987_MP7_acog_sd_t"];
				_allWeapons = _allWeapons +   ["ACR_SD6"];
				_allWeapons = _allWeapons +   ["ACR_SA58REF"];
				_allWeapons = _allWeapons +   ["ACR_SA58ACOG"];
				_allWeapons = _allWeapons +   ["ACR_M4A3"];
				...
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_SIL_FG"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_LP_GL"];
				_allWeapons = _allWeapons +   ["DM_CAMO_M4_RCO_IR_SIL_GL"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_EOT_HG_SD"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_AIM"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_J4_M203"];
				_allWeapons = _allWeapons +   ["R3F_Famas_F1_J4_M203_SD"];
				_allWeapons = _allWeapons +   ["R3F_Famas_felin"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_J4_HG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_AIM_M203"];
				_allWeapons = _allWeapons +   ["R3F_Famas_G2_AIM_HG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_EOT_SD"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_AIM_HG"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_AIM_SD"];
				_allWeapons = _allWeapons +   ["R3F_Famas_surb_EOT_M203"];
				_allWeapons = _allWeapons +   ["R3F_HK417L_NF"];
				_allWeapons = _allWeapons +   ["R3F_HK417M_AIM"];
				_allWeapons = _allWeapons +   ["R3F_HK417S_EOT_HG"];
				_allWeapons = _allWeapons +   ["R3F_HK417S_HG_SD"];
				_allWeapons = _allWeapons +   ["R3F_FRF2_J8"];
				_allWeapons = _allWeapons +   ["R3F_FRF2_J8_SD"];
				_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II"];
				_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II_MILDOT"];
				_allWeapons = _allWeapons +   ["R3F_PGM_Hecate_II_POLY"];
//				_allWeapons = _allWeapons +   ["ACR_AW_308_D"];
				_allWeapons = _allWeapons +   ["ACR_M60E4"];
				_allWeapons = _allWeapons +   ["ACR_M60E4M1"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_EOT"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_J4"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_762_J4"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_762_OB50"];
				_allWeapons = _allWeapons +   ["R3F_minimi_AIM_HG"];
				_allWeapons = _allWeapons +   ["R3F_Minimi_762_EOT_HG"];
//FHQ
				_allWeapons = _allWeapons +   ["FHQ_ACR_WDL_IRN_F"];
				...
				_allWeapons = _allWeapons +   ["FHQ_RSASS_TWS_TAN"];
				_allWeapons = _allWeapons +   ["FHQ_RSASS_SD_TAN"];
				_allWeapons = _allWeapons +   ["FHQ_RSASS_TWS_SD_TAN"];
				...
				_allWeapons = _allWeapons +   ["FHQ_XM2010_NV_SD_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_TWS_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_XM2010_TWS_SD_DESERT"];
				...
				_allWeapons = _allWeapons +   ["FHQ_MSR_SD_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_NV_SD_DESERT"];
				_allWeapons = _allWeapons +   ["FHQ_MSR_TWS_SD_DESERT"];
			};
		};


		{_vec addWeaponCargo [_x,12];
				...
				if	!(_mag in _magazines) then
				{
					...
					for "_i" from 0 to (count _muzzles-1) do 
					{
						_m = [(getArray(configfile >> "cfgWeapons" >> _x >> _muzzles select _i >> "magazines")) select 0];
						_vec addMagazineCargo [_m,10];
					};
				}forEach _allWeapons;
				systemChat str count _magazines;
				{_vec addMagazineCargo [_x,10]} forEach _magazines;
				_allWeapons = nil;
				_magazines = nil;
...
BIS_EVO_DropBox =
{
	...
	clearWeaponCargo _vec;
	clearMagazineCargo _vec;
	_allWeapons = _allWeapons +   ["M9SD", 2];
	_allWeapons = _allWeapons +   ["huntingrifle",2];
	_allWeapons = _allWeapons +   ["M1014", 2];
	_allWeapons = _allWeapons +   ["MP5SD", 2];
	_allWeapons = _allWeapons +   ["M16A2", 2];
	_allWeapons = _allWeapons +   ["m8_compact", 2];
//	_allWeapons = _allWeapons +   ["Mk_48",12];
	_allWeapons = _allWeapons +   ["Mk_48_DES_EP1",12];
	_allWeapons = _allWeapons +   ["RPG18",2];
	_allWeapons = _allWeapons +   ["RPG7V",2];
	_allWeapons = _allWeapons +   ["Igla",2];
...
//new MG ammo
		...
		_vec addmagazinecargo ["EB_200Rnd_556x45_M249_I",12];
//new items
		_allWeapons = _allWeapons +   ["EB_TIscanner",1];
		_allWeapons = _allWeapons +   ["EB_TIGoggles",1];
		_allWeapons = _allWeapons +   ["EB_S10",1];
...
BIS_EVO_AssignTasks =  // Assigns common main city objectives
{
	...
	if( (BIS_EVO_MissionProgress != -1) ) then {
		...
		BIS_EVO_Objective1 setSimpleTaskDestination GetPos (BIS_EVO_MissionTownNames select BIS_EVO_MissionProgress) ;
