...
EGG_EVO_spAAmedium = ["pook_zsu57_tak","pook_brdm2AA_TKINS","pook_brdm2_sa9_GUE","pracs_tk_sa13","FAP_ZPU4vrs","m55a4TruckVRS"];
...
fnc_evalFaction = 
{
	...
	if(_faction == "FR") then 
	{
		...
		[
			...
			["OFrP_PVP_ANF1",1500],
			["OFrP_PVP_WASP",0],
			["OFrP_PVP_WASP_MILAN",0],
			["OFrP_TRM2000",0],
			["OFrP_TRM2000_AA20",0],
			["OFrP_TRM2000_Plateau",0],
			["OFrP_VAB_Mephisto",0],
			["OFrP_VAB_MILAN",0],
			["OFrP_VAB",0],
			["OFrP_VAB_127",0],
		...
		[
			["OFrP_Mirage_5",0],
			["OFrP_Mirage_C",0],
			["OFrP_Mirage_D_AS30L",0],
			["OFrP_Mirage_D_GBU12",0],
			["OFrP_Rafale_B1",0],
			["OFrP_Rafale_B1T",0],
			["OFrP_Rafale_C1",0],
			["OFrP_Rafale_C01",0],
...
rifles = ["huntingrifle", "LeeEnfield", "RH_m14", "M14_EP1", "RH_mk14teot", "RH_mk14t", "RH_mk14tsd", "RH_MK14AIM", "RH_MK14SDAIM", "RH_MK14", "RH_MK14SD", "RH_MK14SDEOTECH", "RH_sc2", "RH_sc2aim", "RH_sc2shd", "RH_m1s", "RH_m1saim","RH_m1steot"];
...
launchers = ["M136"];
//["M136", "SMAW", "Stinger","ukf_gpmg","MAAWS", "BAF_NLAW_Launcher","FFAA_Armas_C90","FFAA_Armas_C100","ukf_law80launcher","Javelin"] + pracsLaunchers;
...
//FFAA
if(isClass(configFile>>"CfgPatches">>"FFAA_main")) then 
{
	launchers = launchers + ["FFAA_Armas_C90","FFAA_Armas_C100"];
};
...
allAssaultrifles = rusassaultRifles + assaultRifles;
allSmgs = russmgs + smgs;
allRifles = rusrifles+rifles;
allmgs = rusmgs+mgs;
allLaunchers = ruslaunchers+launchers;