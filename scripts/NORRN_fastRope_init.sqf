...
execVM "scripts\compileFunctions.sqf";
hint "cac";
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if (count _this  == 2) then
{
	[_heli, _forceDismount] execVM "scripts\fastRope_playerPilotInit.sqf";
} else {
	_timer	= _this select 2;
	_script	= _this select 3;
	if (count _this  == 5) then {_distance = _this select 4};
	[_heli, _forceDismount, _timer, _script] execVM "scripts\fast_rope_AI_pilot.sqf";
};
