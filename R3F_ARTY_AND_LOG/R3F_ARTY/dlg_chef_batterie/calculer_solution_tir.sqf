/**
 * Execut� lors du clic sur le bouton "Calculer". Contr�le la saisie et lance la calcul de la solution de tir
 * 
...
if (_entrees_valides) then
{
	...
	// Conversion des coordonn�es long-lat en position [X, Y, Z] du jeu
	...
	// R�cup�ration des propri�t�s balistique de la munition
	...
	// Si la dispersion souhait�e est inf�rieure � 10m, on ne fera qu'un seul calcul, car la pr�cision des munitions est d�j� de cet ordre l�
	...
	// Si une dispersion volontaire est souhait�e
	else
	{
		private ["_solution_tir_proche", "_solution_tir_loin", "_azimut_inf", "_azimut_sup"];
		
		// On va faire deux calculs d'�l�vation : en haut et en bas de la zone de dispersion
