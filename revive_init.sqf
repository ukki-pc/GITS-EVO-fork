...
NORRN_player_units = [eng1,eng2,eng3,eng4,eng5,eng6,eng7,eng8,eng9,eng10,eng11,eng12,eng13,eng14,eng15,eng16,eng17,eng18,eng19,eng20,eng21,eng22];
...
// ==================================================================
// REVIVE OPTIONS
_max_respawns 					= (paramsArray select 15);			//array no.38 - Number of lives per unit
...
//_caseVAC						= [1, ["MASH","HMMWV_Base","M1133_MEV_EP1"]];	//array no.64 - Allows units to be taken to a hospital etc to be revived

_caseVAC						= [1, ["Mi17_medevac_RU","Mi17_medevac_Ins","Mi17_medevac_CDF","GAZ_Vodnik_MedEvac","HMMWV_Ambulance","BMP2_Ambul_INS","BMP2_Ambul_CDF","AAVAmbul","GUE_WarfareBFieldhHospital","CDF_WarfareBFieldhHospital","INS_WarfareBFieldhHospital","RU_WarfareBFieldhHospital","USMC_WarfareBFieldhHospital","MASH","HMMWV_Base","HMMWV_Ambulance_CZ_DES_EP1","HMMWV_Ambulance_DES_EP1","M113Ambul_UN_EP1","M113Ambul_TK_EP1","M1133_MEV_EP1","S1203_ambulance_EP1","TK_GUE_WarfareBFieldhHospital_Base_EP1","TK_GUE_WarfareBFieldhHospital_EP1","TK_WarfareBFieldhHospital_Base_EP1","TK_WarfareBFieldhHospital_EP1","US_WarfareBFieldhHospital_Base_EP1","US_WarfareBFieldhHospital_EP1","MASH_EP1","CH_47F_EP1","UH60M_MEV_EP1","ibr_van_AMB","vil_aifv_ypr2","PRACS_puma330_MED","PRACS_M113_AMB","Doctor","RU_Doctor","Dr_Annie_Baker_EP1","Dr_Hladik_EP1","ibr_paramedic"]];	//Revive array no.64 - Allows units to be taken to a hospital etc to be revived
...
// ==================================================================
// RESPAWN OPTIONS
_no_respawn_points 				= param1;				//array no.12 - no of respawn points (Max number 4)  
...
_medic_1						= "CZ_Soldier_medik_DES_EP1";	//array no.76 - Used in conjunction with medpacks and bleeding	
_medic_2						= "US_Delta_Force_Medic_EP1";				//array no.77 - Used in conjunction with medpacks and bleeding
_medic_3						= "GER_Soldier_Medic_EP1";				//array no.78 - NOT IMPLEMENTED	
_medic_4						= "BAF_Soldier_Medic_MTP";				//array no.79 - NOT IMPLEMENTED	
//========================================================
